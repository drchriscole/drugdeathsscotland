...
# Drug-Related Deaths in Scotland 2017 {.tabset}
...
A collection of visualisations of the [2017 data](https://www.nrscotland.gov.uk/files//statistics/drug-related-deaths/17/drug-related-deaths-17-tabs-figs.xlsx) are presented here for those interested in exploring the trends or patterns in the data. Little to no commentary is provided on what the data show.
...
# extract core data and convert to numbers
dat = table.dat[c(25:29,32:36),c(1,3:14)]
colnames(dat) <-c('Age','Heroin/morphine','Methodone','Heroin or OST','Codeine', 'Dihydrocodeine', 'Any opiate', 'Any benzodiazepine', 'Diazepam', 'Cocaine', 'Ecstasy', 'Amphetamines', 'Alcohol')
...
# subtract the diazepam data from 
# the any benzo data to make an "other benzo" column
dat = data.frame(dat, "Other benzodiazepines"= as.numeric(dat$Any.benzodiazepine) - as.numeric(dat$Diazepam))
