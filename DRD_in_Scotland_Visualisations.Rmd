...
This is a test visualisation. 

```{r tC1, fig.width=6, fig.height=7}
...
ggplot(dat.m, aes(x=variable, y=value, group=Council)) +
  ggtitle("Drug-Related Deaths by Council") +
  xlab('Year') +
  ylab('No. Deaths') +
  geom_line(size=1.1, colour='darkgreen') +
  scale_x_discrete(breaks=c(2008, 2018), labels=c("'08","'18")) +
  facet_wrap(~Council) +
  theme_minimal() +
  theme(panel.background = element_rect(fill='#e0ecff'),
