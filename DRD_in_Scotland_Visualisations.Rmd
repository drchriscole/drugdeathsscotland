...
sg_hb <- st_read('SG_NHS_HealthBoards_2019/SG_NHS_HealthBoards_2019.shp')
...
spdf <- geojson_read("topo_lad.json",  what = "sp")
...
spdf <- spdf[ spdf@data$LAD13NM  %in% c("Fife") , ]
spdf_fortified <- tidy(spdf, region = "LAD13NM")
...
library(eurostat)
spdf = get_eurostat_geospatial(output_class = 'spdf', nuts_level = '3')
spdf_UK = spdf[spdf@data[["CNTR_CODE"]] %in% c('UK'), ]
spdf_UK@data[["NUTS_NAME"]]
