...
dat$Council = c("Abz", "Absh", "Angus", "Argyll", "Edi", "Clk", "DnG", "Dundee", "E. Ayr", "E. Dun", "E. Loth", "E. Ren", "Falkirk", "Fife", "Glasgow", "Highland", "Inverclyde", "Midlothian", "Moray", "Na h-Eil", "N. Ayr", "N. Lan", "Orkney", "PnK", "Ren", "SBord", "Shetld", "S. Ayr", "S. Lan", "Stirling", "W. Dun", "West Loth")
...
ggplot(dat.m, aes(x=variable, y=value, group=Council, colour=ifelse(Council == "Dundee", "A","B"))) +
  ggtitle("Drug-Related Deaths per 1,000 population", subtitle = "By council area") +
  ylab("Death Rate") +
  xlab("Age Group") +
  geom_line() +
